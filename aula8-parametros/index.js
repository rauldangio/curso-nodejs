...
app.get("/ola/:cargo/:nome/:cor",function(req,res){ // os dois pontos no caminho é o parametro, o parametro é um valor interativo que o usuario pode colocar
    ...
    res.send(`<h1>Ola ${req.params.nome}</h1> <h2> Seu cargo é ${req.params.cargo}</h2> <h2>Sua cor é ${req.params.cor}</h2>`); // req = objeto que armazena todos os valores da requisão, params os parametros, e o nome é o parametro nome.
